...
function loDropImage() {
    ...
    let div = $("<div class='container'></div>").append( dropZone, aboutText());
    $("#mainLayout").html(div);
    setTitle('<span class="text-secondary">Pixel Generator</span>');
...
function loAdjustPortrait(chooseOptions, opt) {
    ...
    rightPanel.append(
        ...
        //$("<hr>"),
        buildRangesDiv(),
        //collapseBtn,//MORE OPTION BUTTON
        collapsedDiv,
    );
    //rightPanel.append(newMosaicBtn);
